...
import { generateDocxReport } from './src/services/reportGenerator'; // Você criará este arquivo
import { QueryResultFeature, QueryResult, ReportData } from 'src/models/ResultsData'
